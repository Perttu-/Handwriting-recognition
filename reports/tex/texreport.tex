        ...
        \subsection{Block Based Hough Transform Mapping}
          ...
          \subsubsection{Subgroups}
            ...
            \begin{figure}
              ...
              \caption{Component space partioned to 3 subsets. Here AH and AW are average height and average width of components respectively. \label{fig:subgroupspace}}
          ...
          \subsubsection{Hough Transform Mapping}
            The Hough transform is an feature extraction technique used to often find lines in images. The theory is that location of each processed pixel can be described in Hessian normal form:
            \begin{equation}
          ...
          The proposed line detection method requires additional constraints and techniques to work with objects that are not classified to lines with Hough transform mapping or if two or more lines overlap.
